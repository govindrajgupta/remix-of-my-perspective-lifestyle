...
const DummyContent = () => {
  return (
    <div className="container mx-auto max-w-7xl px-4 py-32">
      <p className="mb-4 text-center text-xl font-bold text-neutral-900 dark:text-neutral-100">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        {[
          ...
          <div
            key={box.id}
            className={`${box.width} ${box.height} ${box.bg} flex items-center justify-center rounded-lg`}
          >
